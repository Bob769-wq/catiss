...
@Component({
  ...
  template: `
    <header>
      <div class="w-[87.5rem] max-w-full min-h-20 px-5 py-[.9375rem] mx-auto bg-white">
        <div class="flex flex-col items-center relative">
          <a class="max-h-[6.25rem]"><img src="/logo.webp" class="max-h-[6.25rem]" alt="logo" /></a>
...
export class Header {
  ...
  navItems: NavList[] = [
    { id: 1, title: '關於CATISS', link: '/' },
    { id: 2, title: '所有商品', link: '/' },
    {
      id: 3,
      title: 'CATISS貓掌護唇膏',
      link: '/',
